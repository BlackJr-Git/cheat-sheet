...
export default async function Login() {
  ...
  return (
    <div className="flex h-[54vh] w-full items-center justify-center mt-24">
      ...
      <div className="w-2/3 flex flex-col justify-center items-center border-l-2 border-violet-500">
